...
sed -i -e "s/mvc-1.0-blank/projectName/g" pom.xml
sed -i -e "s/github\.com\/making\/projectName/github.com\/making\/mvc-1.0-blank/g" pom.xml
...
sed -i -e "s/projectName/mvc-1.0-blank/g" pom.xml
